...
namespace Magecom\ViewedProducts\Block\Adminhtml\Product\Edit\Tab;
...
class Viewed extends Extended
{
    ...
    {
        parent::_construct();
        $this->setId('viewed_product_grid');
    ...
    {
        return $this->getProduct() && $this->getProduct()->getViewedReadonly();
    }
    ...
    /**
     * Retrieve selected viewed products
     *
     * @return array
     */
     ...
     * @return array
     */
    public function getSelectedViewedProducts()
    {
        $products = [];
        foreach ($this->_coreRegistry->registry('current_product')->getViewedProducts() as $product) {
